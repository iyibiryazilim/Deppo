...
namespace Deppo.Mobile.Modules.SalesModule.SalesProcess.ReturnProductSalesDispatchProcess.ViewModels
{
    ...
    public partial class ReturnSalesDispatchCustomerListViewModel : BaseViewModel
    {
        ...
        public ReturnSalesDispatchCustomerListViewModel(IHttpClientService httpClientService, ISalesCustomerService salesCustomerService, ISalesCustomerProductService salesCustomerProductService, IShipAddressService shipAddressService, IUserDialogs userDialogs)
        {
        ...
        private async Task LoadItemsAsync()
        {
            ...
            try
            {
                ...
                var result = await _salesCustomerService.SalesCustomerQueryFiche(httpClient, _httpClientService.FirmNumber, _httpClientService.PeriodNumber, warehouseNumber: WarehouseModel.Number, skip: 0, take: 20, search: string.Empty);
        ...
        private async Task LoadMoreItemsAsync()
        {
            ...
            try
            {
                ...
                var httpClient = _httpClientService.GetOrCreateHttpClient();
                var result = await _salesCustomerService.SalesCustomerQueryFiche(httpClient, _httpClientService.FirmNumber, _httpClientService.PeriodNumber, warehouseNumber: WarehouseModel.Number, skip: Items.Count, take: 20, search: string.Empty);
