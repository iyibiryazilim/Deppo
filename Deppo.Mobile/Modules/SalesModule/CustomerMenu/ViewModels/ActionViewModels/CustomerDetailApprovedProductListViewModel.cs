...
public partial class CustomerDetailApprovedProductListViewModel : BaseViewModel
{
	...
	public CustomerDetailApprovedProductListViewModel(IHttpClientService httpClientService, ICustomerDetailActionService customerDetailActionService, IUserDialogs userDialogs)
	{
		_httpClientService = httpClientService;
		_customerDetailActionService = customerDetailActionService;
		_userDialogs = userDialogs;

		Title = "Satılabilen Ürünler";
	...
	private async Task LoadItemsAsync()
	{
		...
		try
		{
			...
			var result = await _customerDetailActionService.GetApprovedProductsByCustomer(
