...
public partial class QuicklyProductionOutputProductListViewModel : BaseViewModel
{
        ...
        IUserDialogs userDialogs)
    {
        ...
        Title = "Tüketilen Malzeme Listesi";
    ...
    private async Task LoadMoreItemsAsync()
    {
        ...
        try
        {
            ...
            var result = await _quicklyProductionPanelService.GetQuicklyProductionOutputProductListAsync(httpClient: httpClient, firmNumber: _httpClientService.FirmNumber, periodNumber: _httpClientService.PeriodNumber, search: string.Empty, skip: 0, take: 20);
    ...
    private async Task GetLastCountingTransactionsAsync(ProductModel productModel)
    {
        try
        {
            Transactions.Clear();
            var httpClient = _httpClientService.GetOrCreateHttpClient();
            var result = await _quicklyProductionPanelService.GetOutputTransactions(
                httpClient: httpClient,
                firmNumber: _httpClientService.FirmNumber,
                periodNumber: _httpClientService.PeriodNumber,
