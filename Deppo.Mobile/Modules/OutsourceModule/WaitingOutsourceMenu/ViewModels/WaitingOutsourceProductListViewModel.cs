...
public partial class WaitingOutsourceProductListViewModel : BaseViewModel
{
    ...
    private async Task LoadItemsAsync()
    {
        ...
        try
        {
            ...
            await Task.Delay(1000);
            var httpClient = _httpClientService.GetOrCreateHttpClient();
            var result = await _warehouseTotalService.GetObjects(httpClient, firmNumber: _httpClientService.FirmNumber, periodNumber: _httpClientService.PeriodNumber, warehouseNumber: SelectedWarehouseModel.Number);
