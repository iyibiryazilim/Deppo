...
public partial class ProductOutputTransactionViewModel : BaseViewModel
{
	private readonly IHttpClientService _httpClientService;
	private readonly ICustomQueryService _customQueryService;
	private readonly IUserDialogs _userDialogs;
	public ProductOutputTransactionViewModel(IHttpClientService httpClientService, ICustomQueryService customQueryService, IUserDialogs userDialogs)
	{
		_httpClientService = httpClientService;
		_customQueryService = customQueryService;
		_userDialogs = userDialogs;

		Title = "Malzeme Çıkış Hareketleri";
	...
	async Task LoadItemsAsync()
	{
		...
		WHERE STLINE.IOCODE IN (3,4) AND ITEMS.LOGICALREF = {Product.ReferenceId}";
