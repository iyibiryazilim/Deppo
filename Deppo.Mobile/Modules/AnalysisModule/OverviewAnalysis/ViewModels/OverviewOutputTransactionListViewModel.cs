...
{
	public partial class OverviewOutputTransactionListViewModel : BaseViewModel
	{
		...
		public OverviewOutputTransactionListViewModel(IHttpClientSysService httpClientSysService, ITransactionAuditService transactionAuditService, IUserDialogs userDialogs, IOverviewAnalysisTransactionService overviewAnalysisTransactionService, IHttpClientService httpClientService)
		{
		...
		public async Task LoadItemsAsync()
		{
			...
			try
			{
				...
				string filter = $"expand=ApplicationUser($expand=Image)&$filter=IOType in (3,4)&$orderby=TransactionDate desc";
