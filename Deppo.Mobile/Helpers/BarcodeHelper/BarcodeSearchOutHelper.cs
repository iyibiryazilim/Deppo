...
public class BarcodeSearchOutHelper : IBarcodeSearchOutHelper
{
	private readonly IBarcodeSearchOutService _barcodeSearchOutService;


	public BarcodeSearchOutHelper(IBarcodeSearchOutService barcodeSearchOutService)
	{
	...
	public async Task<dynamic> BarcodeDetectedAsync(HttpClient httpClient, int firmNumber, int periodNumber, string barcode, int warehouseNumber, string comingPage)
	{
		...
		try
		{
			...
			//{
			//	SearchBySupplierProductCodeAsync(httpClient, firmNumber, periodNumber, barcode, warehouseNumber),
			//	SearchBySupplierVariantCodeAsync(httpClient, firmNumber, periodNumber, barcode, warehouseNumber),
	...
	private async Task<dynamic> SearchByProductCodeAsync(HttpClient httpClient, int firmNumber, int periodNumber, string barcode, int warehouseNumber)
	{
		try
		{
			if (!isFind)
	...
	private async Task<dynamic> SearchByProductMainBarcodeAsync(HttpClient httpClient, int firmNumber, int periodNumber, string barcode, int warehouseNumber)
	{
		try
		{
			if (!isFind)
	...
	private async Task<dynamic> SearchByProductSubBarcodeAsync(HttpClient httpClient, int firmNumber, int periodNumber, string barcode, int warehouseNumber)
	{
		try
		{
			if (!isFind)
	...
	private async Task<dynamic> SearchByProductSeriNumberAsync(HttpClient httpClient, int firmNumber, int periodNumber, string barcode, int warehouseNumber)
	{
		try
		{
			if (!isFind)
	...
	private async Task<dynamic> SearchByProductLotNumberAsync(HttpClient httpClient, int firmNumber, int periodNumber, string barcode, int warehouseNumber)
	{
		try
		{
			if (!isFind)
