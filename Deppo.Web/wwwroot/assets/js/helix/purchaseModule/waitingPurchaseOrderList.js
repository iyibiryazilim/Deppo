...
// Class definition
var waitingPurchaseOrderList = function () {
    // Shared variables
    var table;
    var datatable;
    let arrayData;
    ...
    var initDatatable = function () {
        ...
        datatable = $(table).DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "WaitingPurchaseOrder/GetObjectsJsonResult",
                type: "POST",
                data: function (d) {
                    return {
                        draw: d.draw,
                        start: d.start,
                        length: d.length,
                        searchText: $('#waitingPurchaseOrderSearchInput').val()
                    };
                }
            },
            columns: [
    ...
    var handleSearchDatatable = () => {
        const filterSearch = document.querySelector('[waiting_purchase_order_list_table="search"]');
    ...
    return {
        init: async function () {
            table = document.querySelector('#waiting_purchase_order_list_table');
