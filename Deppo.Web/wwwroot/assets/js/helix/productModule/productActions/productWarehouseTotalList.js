...
var ShowModalPageInit = function () {
    ...
    var initDatatable = function () {
        ...
        var postUrl = '../Product/GetWarehouseTotals/?productReferenceId=' + id;
        console.log(postUrl);
    ...
    var loadModalPage = function () {
        $('#product_warehouse_total_modal').on('shown.bs.modal', function () {
            initDatatable();
    ...
    var bindEventHandlers = function () {
        $(document).on('click', 'a#ProductWarehouseTotal', function () {
            ...
            $('#productWarehouseTotalInformation').html(`
    ...
    return {
        init: function () {
            table = document.querySelector('#product_warehouse_total_list_table');
