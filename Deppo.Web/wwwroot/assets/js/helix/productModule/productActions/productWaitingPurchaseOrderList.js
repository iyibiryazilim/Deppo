...
// Class definition
var ShowWaitingPurchaseOrderModalPageInit = function () {
    ...
    var initDatatable = function () {
        ...
        var postUrl = '../Product/GetWaitingPurchaseOrders/?productReferenceId=' + id;
        console.log(postUrl);
        ...
        datatable = $(table).DataTable({
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function (data, type, full, meta) {
                        var output;
                        var initials = full.supplierName ? full.supplierName.substring(0, 2).toUpperCase() : '';
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="d-flex justify-content-start flex-column">
                    <a href="#" class="text-dark fw-bold text-hover-primary mb-1 fs-6">${full.supplierCode}</a>
                    <span class="text-muted fw-semibold text-muted d-block fs-7">${full.supplierName}</span>
                </div>
            </div>
        `;
    ...
    var loadModalPage = function () {
        $('#product_waiting_purchase_order_modal').on('shown.bs.modal', function () {
            initDatatable();
    ...
    var bindEventHandlers = function () {
        $(document).on('click', 'a#ProductWaitingPurchaseOrder', function () {
    ...
    return {
        init: function () {
            table = document.querySelector('#product_waiting_purchase_order_list_table');
...
KTUtil.onDOMContentLoaded(function () {
    ShowWaitingPurchaseOrderModalPageInit.init();
});