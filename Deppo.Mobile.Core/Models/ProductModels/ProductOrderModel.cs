...
public class ProductOrderModel : INotifyPropertyChanged, IDisposable
{
    private int _itemReferenceId;
    private string _itemCode = string.Empty;
	private string _itemName = string.Empty;
    private int _mainItemReferenceId = default;
    ...
    private double _quantity = default;
    private double _shippedQuantity = default;
    private double _waitingQuantity = default;
