...
public class ReturnSalesBasketModel : INotifyPropertyChanged, IDisposable
{
    private Guid _referenceId;
    private int _lineReferenceId;
    ...
    private List<ReturnSalesBasketDetailModel> _details = new();
	...
	public int LineReferenceId
	{
		get => _lineReferenceId;
		set
		{
			if (_lineReferenceId == value) return;
			_lineReferenceId = value;
			NotifyPropertyChanged();
		}
	}
	...
	[DisplayName("Diğer Dönüşüm Faktörü")]
	...
	public List<ReturnSalesBasketDispatchModel> Dispatches
    {
        get => _dispatches;
        set
        {
            if (_dispatches == value) return;
            _dispatches = value;
            NotifyPropertyChanged();
        }
    }

    public List<ReturnSalesBasketDetailModel> Details
    {
        get => _details;
        set
        {
