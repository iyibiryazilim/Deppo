...
public interface IShipAddressService
{
    ...
    public Task<DataResult<IEnumerable<dynamic>>> GetObjectsByOrder(HttpClient httpClient, int firmNumber, int periodNumber, int currentReferenceId, string search = "", int skip = 0, int take = 20);
}
