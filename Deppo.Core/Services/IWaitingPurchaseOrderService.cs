...
{
    Task<DataResult<IEnumerable<dynamic>>> GetObjectsBySupplier(HttpClient httpClient, int firmNumber, int periodNumber, int supplierReferenceId, string search = "", int skip = 0, int take = 20, string externalDb = "");
    Task<DataResult<IEnumerable<dynamic>>> GetObjectsByProduct(HttpClient httpClient, int firmNumber, int periodNumber, int warehouseNumber, int supplierReferenceId, int productReferenceId, string search = "", int skip = 0, int take = 20, string externalDb = "");
	...
	Task<DataResult<IEnumerable<dynamic>>> GetObjectsBySupplierAndShipInfo(HttpClient httpClient, int firmNumber, int periodNumber, int supplierReferenceId, int shipInfoReferenceId = 0,  string search = "", int skip = 0, int take = 20, string externalDb = "");
