...
{
	Task<DataResult<IEnumerable<dynamic>>> GetWaitingSalesOrdersByCustomer(HttpClient httpClient, int firmNumber, int periodNumber, int customerReferenceId, string search = "", int skip = 0, int take = 20);
