...
namespace Deppo.Core.Services
{
    public interface IWarehouseInputTransactionService
    {
        ...
        Task<DataResult<IEnumerable<dynamic>>> GetWarehouseInputTransactions(HttpClient httpClient, int firmNumber, int periodNumber, int productReferenceId, string search = "", int skip = 0, int take = 20);
    }
}