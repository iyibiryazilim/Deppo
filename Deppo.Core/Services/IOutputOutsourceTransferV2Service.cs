...
namespace Deppo.Core.Services
{
    public interface IOutputOutsourceTransferV2Service
    {
        ...
        Task<DataResult<IEnumerable<dynamic>>> GetObjectSubProducts(HttpClient httpClient, int firmNumber, int periodNumber, int productReferenceId,  string search = "", int skip = 0, int take = 20);
