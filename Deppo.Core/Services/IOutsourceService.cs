...
public interface IOutsourceService
{
	...
	Task<DataResult<IEnumerable<dynamic>>> GetOutsourceWarehousesAsync(HttpClient httpClient, int firmNumber, int periodNumber,string search = "", int skip = 0, int take = 20, string externalDb = "");
