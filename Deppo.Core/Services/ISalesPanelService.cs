...
public interface ISalesPanelService
{
    ...
    Task<DataResult<IEnumerable<dynamic>>> GetShippedOrders(HttpClient httpClient, int firmNumber, int periodNumber, int productReferenceId, string search = "", int skip = 0, int take = 20, string externalDb = "");
