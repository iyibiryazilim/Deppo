...
namespace Deppo.Core.Services
{
    public interface IWarehouseOutputTransactionService
    {
        ...
        Task<DataResult<IEnumerable<dynamic>>> GetWarehouseOutputTransactions(HttpClient httpClient, int firmNumber, int periodNumber, int productReferenceId, string search = "", int skip = 0, int take = 20);
    }
}