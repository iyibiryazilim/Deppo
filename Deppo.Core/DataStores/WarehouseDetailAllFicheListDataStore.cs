...
namespace Deppo.Core.DataStores
{
    public class WarehouseDetailAllFicheListDataStore : IWarehouseDetailAllFicheListService
    {
        ...
        public async Task<DataResult<IEnumerable<dynamic>>> GetAllFiches(HttpClient httpClient, int firmNumber, int periodNumber, int warehouseNumber, string search = "", int skip = 0, int take = 20, string externalDb = "")
        {
            var content = new StringContent(JsonConvert.SerializeObject(GetLastFichesByProductQuery(firmNumber, periodNumber, warehouseNumber, search, skip, take, externalDb)), Encoding.UTF8, "application/json");
        ...
        public async Task<DataResult<IEnumerable<dynamic>>> GetTransactionsByFiche(HttpClient httpClient, int firmNumber, int periodNumber, int warehouseNumber, int ficheReferenceId, int skip = 0, int take = 20, string externalDb = "")
        {
            var content = new StringContent(JsonConvert.SerializeObject(GetLastProductTransactionQuery(firmNumber, periodNumber, ficheReferenceId, warehouseNumber, externalDb)), Encoding.UTF8, "application/json");
        ...
        private string GetLastFichesByProductQuery(int firmNumber, int periodNumber, int warehouseNumber, string search, int skip, int take, string externalDb = "")
        {
        ...
        private string GetLastProductTransactionQuery(int firmNumber, int periodNumber, int ficheReferenceId, int warehouseNumber, string externalDb = "")
        {
            string baseQuery = $@"SELECT
