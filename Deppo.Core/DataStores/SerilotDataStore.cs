...
public class SerilotDataStore : ISerilotService
{
	...
	{
		var content = new StringContent(JsonConvert.SerializeObject(SerilotQuery(firmNumber, periodNumber, productReferenceId, warehouseNumber, skip, take, search)), Encoding.UTF8, "application/json");
	...
	private string SerilotQuery(int firmNumber, int periodNumber, int productReferenceId, int warehouseNumber, int skip = 0, int take = 20, string search = "")
	{
