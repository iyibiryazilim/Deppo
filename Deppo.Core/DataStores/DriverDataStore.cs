...
namespace Deppo.Core.DataStores
{
    public class DriverDataStore : IDriverService
    {
        ...
        {
            var content = new StringContent(JsonConvert.SerializeObject(CustomerTransaction(firmNumber)), Encoding.UTF8, "application/json");
        ...
        private string GetDrivers(int firmNumber)
        {
