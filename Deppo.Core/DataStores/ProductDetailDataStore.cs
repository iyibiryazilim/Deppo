...
namespace Deppo.Core.DataStores
{
    public class ProductDetailDataStore : IProductDetailService
    {
        ...
        public async Task<DataResult<IEnumerable<dynamic>>> GetLastFichesByProduct(HttpClient httpClient, int firmNumber, int periodNumber, int productReferenceId, string externalDb = "")
        {
        ...
        public async Task<DataResult<IEnumerable<dynamic>>> GetLastTransaction(HttpClient httpClient, int firmNumber, int periodNumber, int ficheReferenceId, int productReferenceId, string externalDb = "")
        {
