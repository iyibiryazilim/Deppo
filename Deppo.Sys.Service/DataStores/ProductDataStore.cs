...
internal class ProductDataStore : IProductService
{
    ...
    public async  Task<Product> CreateAsync(HttpClient httpClient, ProductDto dto)
    {
    ...
    public async Task<IEnumerable<Product>> GetAllAsync(HttpClient httpClient)
    {
        ...
        if (response.IsSuccessStatusCode)
        {
            if (response.StatusCode == System.Net.HttpStatusCode.OK)
            {
                ...
                return JsonNode.Parse(content)["value"].Deserialize<IEnumerable<Product>>();
            }
    ...
    public async Task<IEnumerable<Product>> GetAllAsync(HttpClient httpClient, string filter)
    {
