...
public class SysBlazorApplication : BlazorApplication {
    public SysBlazorApplication() {
        ApplicationName = "Deppo.Sys";
        CheckCompatibilityType = DevExpress.ExpressApp.CheckCompatibilityType.DatabaseSchema;
        DatabaseVersionMismatch += SysBlazorApplication_DatabaseVersionMismatch;
    }
    ...
    private void SysBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
        e.Updater.Update();
        e.Handled = true;
#else
